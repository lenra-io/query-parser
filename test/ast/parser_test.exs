defmodule QueryParser.AST.ParserTest do
  use ExUnit.Case

  @moduledoc """
    Test the `QueryParser.AST.Parser` module
  """
             ...
             find: %AST.Find{
               clause: %AST.And{
                 clauses: [
                   ...
                   %QueryParser.AST.In{
                     values: [
                       %QueryParser.AST.StringValue{value: "Jean Neige"},
                       %QueryParser.AST.StringValue{value: "Jean Noël"}
                     ],
                     field: %QueryParser.AST.DataKey{key_path: ["name"]}
                   }
                 ]
               }
             },
